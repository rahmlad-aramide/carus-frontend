...
export default function DropoffWasteSelector() {
  ...
  return (
    <div className="bg-[#F3F3F3] grid grid-cols-3 md:grid-cols-3 xl:grid-cols-4 gap-y-4 xl:gap-y-6 gap-x-3 xl:gap-1 p-3 md:p-5 rounded-xl">
      {/* Plastic */}
      <Button
        type="plastic"
        label="plastic"
