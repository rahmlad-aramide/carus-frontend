...
export default function Footer() {
  return (
    <div className="">
      ...
      <div className="w-full flex flex-col md:flex-row px-4 md:px-10 md:gap-20 lg:gap-40 mt-15 md:mt-40">
        {/* Logo + text */}
        <div className="md:w-1/3 px-3 md:px-5 mb-10 md:mb-0">
          <Image
            aria-hidden={false}
            src="/logo.png"
            alt="Carus Logo"
        ...
        <div className="flex px-4 gap-x-30 md:gap-x-50">
