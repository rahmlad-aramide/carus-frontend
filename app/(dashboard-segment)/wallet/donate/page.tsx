  ...
  return (
    <div>
      ...
      <div className="pt-26 grid grid-cols-1 lg:grid-cols-2 gap-5">
        {isLoading ? (
          <div className="col-span-full mt-25 flex flex-col justify-center items-center border border-grey-10 rounded-[10px] p-2 space-y-3 h-[250px] xl:overflow-y-auto text-center py-10">
